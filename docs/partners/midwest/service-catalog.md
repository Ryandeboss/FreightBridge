...
| 214 Shipment Status | Midwest reports pickup, transit, arrival, or delivery status | Midwest -> FreightBridge | Future SFTP | X12 004010 | Future FreightBridge processing acknowledgment | MVP |
