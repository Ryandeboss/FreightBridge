...
class FakeOperationsRepository:
  ...
  def _transaction(self, key, partner_code, partner_name, direction, transport, message_format, document_type, status, stage, correlation_id, *, parent=None, created_minute=1, error_count=0):
    return {
      ...
      'replay_of_transaction_id': None,
      'mapping_profile_id': UUID('30000000-0000-0000-0000-000000000001') if message_format == 'X12' else None,
      'mapping_profile_version': 1 if message_format == 'X12' else None,
      'mapping_key': 'CANONICAL_TO_MWCX_204' if message_format == 'X12' else None,
